document.addEventListener("DOMContentLoaded", function() {
  ...
  var loveForJohnHopkins = document.getElementById("loveForJohnHopkins"); // Updated ID
  fadeInOut(loveForJohnHopkins, 1000, 8000);
  ...
  var johnHopkinsText = document.getElementById("johnHopkinsText"); // Updated ID
  setTimeout(function() {
    johnHopkinsText.style.display = "block";
    fadeInOut(johnHopkinsText, 1000, 5000);
  }, 15000);
